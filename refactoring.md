...
- 类型: warning
- 代码: W0611
- 描述: Unused EnvironmentDetector imported from environment_utils
- 符号: unused-import
...
- 类型: warning
- 代码: W0611
- 描述: Unused get_environment_detector imported from environment_utils
- 符号: unused-import
...
- 类型: convention
- 代码: C0415
- 描述: Import outside toplevel (platform)
- 符号: import-outside-toplevel
...
- 类型: convention
- 代码: C0411
- 描述: standard import "logging" should be placed before third party import "environment_utils.EnvironmentDetector"
- 符号: wrong-import-order

## 问题类型: use-implicit-booleaness-not-comparison-to-string
### 问题信息
- 类型: convention
- 代码: C1804
...
## 问题类型: use-implicit-booleaness-not-comparison-to-zero
### 问题信息
- 类型: convention
- 代码: C1805
...
- 类型: warning
- 代码: W0212
- 描述: Access to a protected member _detect_gui_availability of a client class
- 符号: protected-access
...
- 类型: warning
- 代码: W0212
- 描述: Access to a protected member _detect_display of a client class
- 符号: protected-access
...
- 类型: warning
- 代码: W0212
- 描述: Access to a protected member _detect_platform of a client class
- 符号: protected-access
...
- 类型: warning
- 代码: W0212
- 描述: Access to a protected member _find_project_root of a client class
- 符号: protected-access
...
- 类型: convention
- 代码: C0413
- 描述: Import "from environment_utils import EnvironmentDetector, get_environment_detector, EnvironmentType, PlatformType" should be placed at the top of the module
- 符号: wrong-import-position
...
- 类型: warning
- 代码: W0621
- 描述: Redefining name 'project_root' from outer scope (line 23)
- 符号: redefined-outer-name
...
- 类型: warning
- 代码: W0621
- 描述: Redefining name 'project_root' from outer scope (line 22)
- 符号: redefined-outer-name
...
- 类型: warning
- 代码: W0621
- 描述: Redefining name 'project_root' from outer scope (line 21)
- 符号: redefined-outer-name
...
- 类型: warning
- 代码: W0612
- 描述: Unused variable 'success_rate'
- 符号: unused-variable
...
## 问题类型: too-many-positional-arguments
### 问题信息
- 类型: refactor
- 代码: R0917
...
- 类型: error
- 代码: E0602
- 描述: Undefined variable 'get_resource_path'
- 符号: undefined-variable
...
- 类型: error
- 代码: E0602
- 描述: Undefined variable 'get_config_path'
- 符号: undefined-variable
...
- 类型: error
- 代码: E0602
- 描述: Undefined variable 'is_gui_available'
- 符号: undefined-variable

## 问题类型: relative-beyond-top-level
### 问题信息
- 类型: error
- 代码: E0402
...
## 问题类型: consider-merging-isinstance
### 问题信息
- 类型: refactor
- 代码: R1701
...
- 类型: error
- 代码: E0401
- 描述: Unable to import 'environment_utils'
- 出现次数: 3
- 涉及文件数: 3
...
- 类型: error
- 代码: E0601
- 描述: Using variable 'platform' before assignment
- 符号: used-before-assignment

## 问题类型: inconsistent-return-statements
### 问题信息
- 类型: refactor
- 代码: R1710
...
## 问题类型: unbalanced-tuple-unpacking
### 问题信息
- 类型: warning
- 代码: W0632
...
## 问题类型: useless-parent-delegation
### 问题信息
- 类型: warning
- 代码: W0246
...
## 问题类型: assignment-from-no-return
### 问题信息
- 类型: error
- 代码: E1111
...
## 问题类型: consider-using-from-import
### 问题信息
- 类型: refactor
- 代码: R0402
...
## 问题类型: cell-var-from-loop
### 问题信息
- 类型: warning
- 代码: W0640
- 描述: Cell variable test_file defined in loop
- 出现次数: 1
- 涉及文件数: 1
...
## 问题类型: access-member-before-definition
### 问题信息
- 类型: error
- 代码: E0203
