    ...
    def create_input_field(self, parent: Any, placeholder: str = "") -> Any:
        ...
        try:
            ...
            if placeholder:
                ...
                entry.bind('<FocusIn>', lambda e, entry=entry, placeholder=placeholder: self._clear_placeholder(entry, placeholder))
                entry.bind('<FocusOut>', lambda e, entry=entry, placeholder=placeholder: self._set_placeholder(entry, placeholder))
