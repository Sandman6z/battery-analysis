...
from battery_analysis.utils.log_manager import get_log_directory, get_logger
    ...
    def _collect_system_info(self):
        ...
        try:
            system_info = {
                ...
                "application": {"path": sys.argv[0], "cwd": os.getcwd(), "pid": os.getpid()},
            }
        ...
        try:
            ...
            with open(info_file, "w", encoding="utf-8") as f:
                ...
                if "error" in system_info:
                    ...
                    f.write(
                        f"Operating system: {system_info['os']['name']} {system_info['os']['release']} {system_info['os']['version']}\n"
                    )
