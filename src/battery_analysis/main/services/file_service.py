...
class FileService:
    ...
    def create_directory(self, path: str | Path) -> tuple[bool, str]:
        """
        创建目录
    ...
    def delete_directory(self, path: str | Path, recursive: bool = False) -> tuple[bool, str]:
        """
        删除目录
    ...
    def list_files(self, directory: str | Path, pattern: str | None = None) -> list[str]:
        ...
        try:
            # 构建缓存键
            cache_key = f"{directory!s}:{pattern}"
    ...
    def is_file_hidden(self, file_path: str | Path) -> bool:
        """
        检查文件是否隐藏
    ...
    def copy_file(self, source: str | Path, destination: str | Path) -> tuple[bool, str]:
        """
        复制文件
    ...
    def move_file(self, source: str | Path, destination: str | Path) -> tuple[bool, str]:
        """
        移动文件
    ...
    def delete_file(self, file_path: str | Path) -> tuple[bool, str]:
        """
        删除文件
    ...
    def set_file_attributes(self, file_path: str | Path, attributes: dict) -> tuple[bool, str]:
        """
        设置文件属性
    ...
    def hide_file(self, file_path: str | Path) -> tuple[bool, str]:
        """
        隐藏文件
