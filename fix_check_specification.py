...
# 找到check_specification方法的开始和结束位置
start_index = None
end_index = None
method_found = False

for i, line in enumerate(lines):
    if 'def check_specification(self) -> None:' in line:
        start_index = i
        method_found = True
...
if start_index is not None and end_index is not None:
    ...
    print(f"已修复 {file_path} 中的 check_specification 方法")
else:
    print(f"未找到 check_specification 方法")
