...
class TestModuleFunctionsSetLocale:
    ...
    def test_successful_set_locale(self):
        ...
        with patch(
            "battery_analysis.i18n.locale_utils.get_available_locales", return_value=["en", "zh_CN"]
        ), patch("battery_analysis.i18n._load_locale", return_value=True):
...
class TestModuleFunctionsTranslate:
    ...
    def test_translate_with_context(self):
        ...
        with patch(
            "battery_analysis.i18n._po_translator.pgettext", return_value="您好"
        ) as mock_pget:
    ...
    def test_translate_fallback_on_error(self):
        ...
        with patch(
            "battery_analysis.i18n._po_translator.gettext", side_effect=AttributeError("bad")
        ):
    ...
    def test_ngettext_fallback_on_error(self):
        ...
        with patch(
            "battery_analysis.i18n._po_translator.ngettext", side_effect=AttributeError("bad")
        ):
            result = ngettext("cat", "cats", 1)
        assert result == "cat"  # fallback to singular

    def test_get_current_locale(self):
        from battery_analysis.i18n import _current_locale, get_current_locale
    ...
    def test_detects_system_locale(self):
        ...
        with patch("battery_analysis.i18n.locale_utils.detect_system_locale", return_value="en_US"):
            with patch("battery_analysis.i18n.LOCALEDIR", Path("/fake")):
                with patch(
                    "battery_analysis.i18n.locale_utils.get_available_locales", return_value=["en"]
                ):
                    with patch(
                        "battery_analysis.i18n.locale_utils.system_locale_to_code",
                        return_value="en",
                    ):
...
class TestLanguageManager:
    ...
    def test_init_sets_locale(self):
        ...
        with patch(
            "battery_analysis.i18n.language_manager.detect_system_locale", return_value="en"
        ), patch("battery_analysis.i18n.language_manager.set_locale", return_value=True):
            lm = LanguageManager()
    ...
    def test_reset_to_default(self):
        ...
        with patch(
            "battery_analysis.i18n.language_manager.detect_system_locale", return_value="en"
        ), patch.object(lm, "set_locale", return_value=True):
            lm.reset_to_default()
        # should not raise
    ...
    def test_validate_translations(self):
        ...
        lm = LanguageManager()
        with patch.object(lm, "set_locale", return_value=True), patch(
            "battery_analysis.i18n.language_manager._",
            side_effect=lambda x, y=None: "translated" if x == "OK" else x,
        ):
    ...
    def test_get_language_manager_singleton(self):
        from battery_analysis.i18n.language_manager import _language_manager, get_language_manager
    ...
    def test_default_locale_is_english_when_no_saved(self):
        ...
        with patch(
            "battery_analysis.i18n.language_manager.detect_system_locale", return_value="zh_CN"
        ), patch.object(lm, "set_locale", return_value=True) as mock_set:
