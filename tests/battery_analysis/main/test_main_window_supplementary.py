...
def mw():
    ...
    for mgr in ['ui_manager', 'config_manager', 'version_manager', 'report_manager',
                'menu_manager', 'table_manager', 'validation_manager', 'data_processor',
                'theme_manager', 'help_manager', 'temperature_handler',
                'environment_manager', 'visualization_manager', 'dialog_manager',
                'path_manager', 'test_profile_manager', 'signal_connector']:
        setattr(mw, mgr, Mock())
    return mw
